...
| Queue / steer / follow-up chips | Composer queue UI | `composer-parity.test.ts`; `queue_update` store tests | unit | partial — dequeue restores queue text FIFO and keeps the engine pause hold; real-engine/E2E proof remains open |
