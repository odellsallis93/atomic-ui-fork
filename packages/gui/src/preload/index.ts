...
const api: GuiHostApi = {
	...
	getAutocomplete: (text, cursorOffset) => ipcRenderer.invoke(IPC_CHANNELS.getAutocomplete, text, cursorOffset),
	interceptTerminalInput: (data) => ipcRenderer.invoke(IPC_CHANNELS.interceptTerminalInput, data),
	getEntries: (options) => ipcRenderer.invoke(IPC_CHANNELS.getEntries, options),
	...
	updateSettings: (operations) => ipcRenderer.invoke(IPC_CHANNELS.updateSettings, operations),
	setFastMode: (scope, enabled) => ipcRenderer.invoke(IPC_CHANNELS.setFastMode, scope, enabled),
	setTheme: (name) => ipcRenderer.invoke(IPC_CHANNELS.setTheme, name),
	getTrustStatus: () => ipcRenderer.invoke(IPC_CHANNELS.getTrustStatus),
	getTrustOptions: () => ipcRenderer.invoke(IPC_CHANNELS.getTrustOptions),
	applyTrust: (optionId) => ipcRenderer.invoke(IPC_CHANNELS.applyTrust, optionId),
