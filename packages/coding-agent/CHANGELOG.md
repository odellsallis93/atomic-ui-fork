...
- Documented the optional Electron GUI host (`packages/gui` / `@bastani/atomic-gui`) and how it speaks the interactive-engine protocol alongside the TUI, including sessions/themes/auth/trust coverage and shortcuts (`docs/gui.md`).
